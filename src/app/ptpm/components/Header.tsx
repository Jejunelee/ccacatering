  ...
  return (
    ...
    >
      ...
      <div className={animationClass()}>
        <EditableText
          key="header-title"
          componentName="party-trays-header-section"
          blockKey="title"
          defaultText="PARTY TRAYS AND PACKED MEALS"
      ...
      <div className="mt-10 w-full max-w-6xl bg-[#F68A3A] text-white rounded-tl-4xl rounded-tr-xl rounded-br-4xl rounded-bl-xl py-4 px-4 flex flex-col items-center justify-center shadow-md">
        <EditableText
          ...
          defaultText="Make it feel easy with"
        ...
        <EditableText
          ...
          componentName="party-trays-header-section"
          blockKey="cta_title"
          defaultText="Party Trays or Packed Meals!"
