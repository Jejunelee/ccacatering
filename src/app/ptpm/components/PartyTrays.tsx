...
export default function EventCateringSection() {
  ...
  return (
    <section className="w-full py-12 bg-gradient-to-l from-[#fbf0e1] via-transparent to-transparent">
...
Our customizable party trays feature a delectable assortment of appetizers, main courses, and desserts, crafted with the finest ingredients and culinary expertise. From classic Filipino favorites to international cuisine, we have something to please every palate.
              </p>
