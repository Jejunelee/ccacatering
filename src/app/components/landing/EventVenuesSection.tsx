...
const COMPONENT_NAME = "event-venues-section" as const;
...
export default function EventVenuesSection() {
  ...
  const handleButtonClick = useCallback(() => {
    console.log("Check Venues button clicked");
    // Add your actual navigation logic here
    // Example: router.push('/venues');
  }, []);
  ...
  return (
    <section 
      ...
      aria-label="Event Venues Section"
    >
            ...
            <div className="max-w-lg">
              ...
              <div className={getAnimationClass(ANIMATION_DELAYS.description)}>
                <EditableText
                  ...
                  as="textarea"
                  rows={4}
                  aria-label="Event Venues Description"
                />
              </div>
              ...
              <div className={getAnimationClass(ANIMATION_DELAYS.button)}>
                <button 
                  ...
                  aria-label="Check available event venues"
                >
                  <EditableText
                    key={`${COMPONENT_NAME}-button-text`}
                    componentName={COMPONENT_NAME}
                    blockKey="button_text"
                    defaultText="Check Venues"
                    className="font-din"
                    tag="span"
                  />
                </button>
