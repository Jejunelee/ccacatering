...
const COMPONENT_NAME = "ptpm-section" as const;
...
export default function PTPMSection() {
  ...
  const handleButtonClick = useCallback(() => {
    console.log("Check Party Trays button clicked");
    // Add your actual navigation logic here
    // Example: router.push('/party-trays');
  }, []);
  ...
  return (
    <section 
      ...
      aria-label="Party Trays & Packed Meals Section"
    >
            ...
            <div className="max-w-lg">
              ...
              <div className={getAnimationClass(ANIMATION_DELAYS.heading)}>
                <EditableText
                  ...
                  blockKey="heading"
                  defaultText="PARTY TRAYS & PACKED MEALS"
                  className="text-4xl md:text-5xl text-[#F48221] mb-2 md:mb-4 font-romanwood"
                  tag="h1"
                  aria-label="Party Trays & Packed Meals Heading"
                />
              </div>
              ...
              <div className={getAnimationClass(ANIMATION_DELAYS.description)}>
                <EditableText
                  ...
                  as="textarea"
                  rows={4}
                  aria-label="Party Trays & Packed Meals Description"
                />
              </div>
              ...
              <div className={getAnimationClass(ANIMATION_DELAYS.button)}>
                <button 
                  ...
                  aria-label="Browse party trays and packed meals"
                >
                  <EditableText
                    key={`${COMPONENT_NAME}-button-text`}
                    componentName={COMPONENT_NAME}
                    blockKey="button_text"
                    defaultText="Check Trays"
                    className="font-din"
                    tag="span"
                  />
                </button>
